...
export function createAchievement(http: HttpClient, rootUrl: string, params: CreateAchievement$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
...
createAchievement.PATH = '/achievement/{activity-id}';
