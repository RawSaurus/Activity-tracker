...
export function findById2(http: HttpClient, rootUrl: string, params: FindById2$Params, context?: HttpContext): Observable<StrictHttpResponse<ActivityResponse>> {
...
findById2.PATH = '/activity/{activity-id}';
